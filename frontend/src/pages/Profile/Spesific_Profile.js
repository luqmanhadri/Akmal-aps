            ...
            >
              <MDBCardBody className="text-center">
                ...
                <MDBCardText className="mb-4"
                  style={{ color: 'white' }}>{profileDetails.role.charAt(0).toUpperCase() 
                  + profileDetails.role.slice(1)}</MDBCardText>
                  ...
                  {datatoken && datatoken._id === path ? (
                    ...
                    onClick={() => 
                      {if (datatoken.approved === false) {
                        ...
                        navigate("/update_profile")}}> Edit Profile </button>
                  ) : (
                    <div></div>
                  )}
                    ...
                    {datatoken && datatoken._id === path ? (
                      ...
                      onClick={() => 
                        { if (datatoken.approved === false) {
                          ...
                          setOpenAchievement(true)}}> Add Achievements </button>
                    ) : (
                      <div></div>
                    )}
                  </MDBListGroupItem>
